...
val craftingtable_recipe = [
    ...
    <item:sophisticatedbackpacks:stack_downgrade_tier_1>,
    <item:sophisticatedbackpacks:stack_downgrade_tier_2>,
    ...
    <item:sophisticatedbackpacks:infinity_upgrade>,
    <item:sophisticatedbackpacks:survival_infinity_upgrade>,
	...
	<item:ad_astra:etrionic_blast_furnace>
];

for item in craftingtable_recipe {
